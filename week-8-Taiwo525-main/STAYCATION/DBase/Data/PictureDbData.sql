...
INSERT INTO dbo.PictureDb (hotelImageUrl, hotelName, hotelLocation, hotelPrice, hotelDescription, hotelGroup, hotelPopularity, IsPopular)
VALUES ('https://staycations.blob.core.windows.net/staycation/Oceanland.svg', 'Ocean Land', 'Bandung Indonesia', 40, 'null', 'null', 'Most Picks', 'false')
...
INSERT INTO dbo.PictureDb (hotelImageUrl, hotelName, hotelLocation, hotelPrice, hotelDescription, hotelGroup, hotelPopularity, IsPopular)
VALUES ('https://staycations.blob.core.windows.net/staycation/Green-Lake.png', 'Green Lake', 'Nature', 'null', 'Treasures', 'Treasure to choose', 'null', 'false')

INSERT INTO dbo.PictureDb (hotelImageUrl, hotelName, hotelLocation, hotelPrice, hotelDescription, hotelGroup, hotelPopularity, IsPopular)
VALUES ('https://staycations.blob.core.windows.net/staycation/Dog-Clubs.png', 'Dog Clubs', 'Pool', 'null', 'Treasures', 'Treasure to choose', 'null', 'false')

INSERT INTO dbo.PictureDb (hotelImageUrl, hotelName, hotelLocation, hotelPrice, hotelDescription, hotelGroup, hotelPopularity, IsPopular)
VALUES ('https://staycations.blob.core.windows.net/staycation/Labour-Wait.png', 'Labour and Wait', 'Shopping', 'null', 'Treasures', 'Treasure to choose', 'Popular Choice', 'true')

INSERT INTO dbo.PictureDb (hotelImageUrl, hotelName, hotelLocation, hotelPrice, hotelDescription, hotelGroup, hotelPopularity, IsPopular)
VALUES ('https://staycations.blob.core.windows.net/staycation/Snorking.png', 'Snorkeling', 'Beach', 'null', 'Treasures', 'Treasure to choose', 'null', 'false')
